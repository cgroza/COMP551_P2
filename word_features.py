...
def get_training_words():
    if not os.path.exists("positive_train_words.data"):
        ...
        with open("negative_train_words.data") as f:
            negative_train_words = eval(f.read())

        with open("positive_train_words.data") as f:
            positive_train_words = eval(f.read())
